...
Wiz v. Pyro is a 2D platformer demo built using a custom component-based game engine written in C++20.
...
Add screenshots to a "screenshots" folder in the project.
